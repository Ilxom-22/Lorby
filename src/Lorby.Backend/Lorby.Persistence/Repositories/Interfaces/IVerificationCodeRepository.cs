...
/// <summary>
/// Represents an interface for managing user information verification codes.
/// </summary>
public interface IVerificationCodeRepository
{
    ...
    IQueryable<VerificationCode> Get(Expression<Func<VerificationCode, bool>>? predicate = default,
    ...
    /// </returns>
    ValueTask<VerificationCode?> GetByIdAsync(Guid codeId, bool asNoTracking = false,
    ...
    /// </returns>
    ValueTask<VerificationCode> CreateAsync(VerificationCode verificationCode, bool saveChanges = true,
        CancellationToken cancellationToken = default);
